                ...
                <form action="{{ route('admin.bank-accounts.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div>
                        ...
                        <input type="text" name="bank_name" class="form-input @error('bank_name') border-rose-500 @enderror"
                            value="{{ old('bank_name') }}" required placeholder="Contoh: Bank BCA, Bank Mandiri">
                        @error('bank_name')
                            <p class="text-xs text-rose-600 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="account_number"
                            ...
                            value="{{ old('account_number') }}" required placeholder="Nomor rekening bank">
                    ...
                    <div>
                        ...
                        <input type="text" name="account_holder"
                            ...
                            value="{{ old('account_holder') }}" required placeholder="Nama pemilik rekening bank">
                    ...
                    <div class="pt-2 flex justify-end gap-2 border-t border-slate-200">
                        ...
                        <button type="submit" class="btn-primary text-xs">Simpan Metode</button>
                    </div>
                </form>
            </div>
        </div>
